 ...
 */
public class NumeroAleatorio extends javax.swing.JFrame {

    /**
     * Creates new form NumeroAleatorio
     */
    ...
    private void initComponents() {
        ...
        lblResultado.setText("NUMERO ALEATORIO GERADO");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtNumeroInicial, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btnSortearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSortearActionPerformed
        ...
        int na1 = Integer.parseInt(txtNumeroInicial.getText());
        int na2 = Integer.parseInt(txtNumeroFinal.getText());
        int resultado = (int) (na1 + ale * (na2 - na1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NumeroAleatorio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NumeroAleatorio().setVisible(true);
            }
        });
    }
